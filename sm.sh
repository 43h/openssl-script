...
./GmSSL-master/apps/gmssl req -new -key ca.key -out ca.csr -subj /CN=ca.cn/C=CN/ST=GD/L=SZ/O=GENEW/OU=NC -config ./conf/ca.conf
./GmSSL-master/apps/gmssl req -x509 -sm3 -days 3650 -key ca.key -in ca.csr -out ca.cert.pem  -subj /CN=ca.cn/C=CN/ST=GD/L=SZ/O=GENEW/OU=NC -config ./conf/ca.conf
...
./GmSSL-master/apps/gmssl req -new -key peer1.enc.key -out peer1.enc.csr -subj /CN=peer1.cn/C=CN/ST=GD/L=SZ/O=GENEW/OU=NC -config ./conf/enc.conf -batch
./GmSSL-master/apps/gmssl req -new -key peer1.sig.key -out peer1.sig.csr -subj /CN=peer1.cn/C=CN/ST=GD/L=SZ/O=GENEW/OU=NC -config ./conf/sig.conf -batch
...
./GmSSL-master/apps/gmssl req -new -key peer2.enc.key -out peer2.enc.csr -subj /CN=peer2.cn/C=CN/ST=GD/L=SZ/O=GENEW/OU=NC -config ./conf/enc.conf
./GmSSL-master/apps/gmssl req -new -key peer2.sig.key -out peer2.sig.csr -subj /CN=peer2.cn/C=CN/ST=GD/L=SZ/O=GENEW/OU=NC -config ./conf/sig.conf
